	...
	OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Rosilene Farias")
								.url("https://www.linkedin.com/in/rosilene-fariasdomingues/")
								.email("rosilene.farias00@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github").url("https://github.com/Rosifaarias"));
	}
